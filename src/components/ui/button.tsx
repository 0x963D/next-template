...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        white:
          "button text-secondary-foreground text-n-8 bg-white shadow-sm hover:bg-white/90 transition-colors hover:text-color-1",
      ...
      size: {
        default: "h-9 px-4 py-2 rounded-tr-[20px]",
        sm: "h-8 px-3 text-xs rounded-tr-[20px]",
        lg: "h-10 px-8 rounded-tr-[24px]",
        icon: "h-9 w-9"
      }
    },
    defaultVariants: {
